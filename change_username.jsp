...
<html>
	<head>
		<meta charset="UTF-8">
		<title>gift::change UserName</title>
	...
	<body>
		<div id="container_body">
			...
			<div id="main_body">
				...
				<form action="change_username.do" method="post" id="loginform">
					<div id="user_box">
						<div id="img_box">
					...
					<table align="center" >
						<tr>
							...
							<td>
								<input type="text" placeholder="Enter New UserName" class="fields" name="username">
							</td>
						</tr>
					</table>
