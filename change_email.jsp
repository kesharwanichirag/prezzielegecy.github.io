	...
	<body>
		<div id="container_body">
			...
			<div id="main_body">
				...
				<form action="change_email.do" method="post" id="loginform">
					<div id="user_box">
						<div id="img_box">
					...
					<table align="center" >
						<tr>
							<td>
								<img src="static/images/email.png" class="labels">
							</td>
							<td>
								<input type="email" placeholder="Enter New Email" class="fields" name="email">
							</td>
						</tr>
					</table>
					<input type="submit" value="Save" id="button"><br><br><br><br>
				</form>
				<br>
			</div>
